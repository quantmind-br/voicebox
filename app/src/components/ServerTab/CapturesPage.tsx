...
export function CapturesPage() {
  ...
  const geminiSmart = sttEngine === 'gemini' && providerSettings?.gemini_stt_mode === 'smart';
      ...
      <div className="flex-1 min-w-0 max-w-2xl space-y-10">
        ...
        >
          <SettingRow
            ...
            action={
              <Select
                value={sttEngine}
                onValueChange={(value: 'whisper' | 'gemini') => update({ stt_engine: value })}
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="gemini">
                    {t('settings.captures.transcription.engine.gemini')}
                  </SelectItem>
                </SelectContent>
              </Select>
            }
          >
            {sttEngine === 'gemini' && !providerSettings?.gemini_key_present ? (
              <Link to="/settings/providers" className="text-sm text-accent hover:underline">
                {t('settings.captures.transcription.engine.configure')}
              </Link>
            ) : null}
          </SettingRow>
        ...
        >
          <SettingRow
            ...
            description={
              geminiSmart
                ? t('settings.captures.refinement.smartNote')
                : t('settings.captures.refinement.auto.description')
            }
            htmlFor="autoRefine"
            action={
              <Toggle
          ...
          <SettingRow
            ...
            action={
              <Select
                ...
                disabled={!autoRefine || geminiSmart}
              >
